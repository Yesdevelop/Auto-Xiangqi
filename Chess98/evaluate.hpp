...
WEIGHT_MAP OPEN_ATTACK_KING_PAWN_WEIGHT = {
    {
        ...
        {0, 0, 0, 21, 50, 123, 162, 192, 207, 27},
        {10037, 10006, 10000, 0, 0, 162, 177, 222, 252, 33},
        {10053, 10020, 10000, 45, 48, 177, 183, 222, 267, 39},
        {10037, 10006, 10000, 0, 0, 162, 177, 222, 252, 33},
        {0, 0, 0, 21, 50, 123, 162, 192, 207, 27},
        {0, 0, 0, 0, 0, 111, 138, 147, 147, 27},
        {0, 0, 0, 21, 21, 87, 117, 117, 117, 27},
...
const int ROOK_EXTEND_FACTOR = 3;
const int ROOK_EXTEND_MARGIN = (ROOK_EXTEND * 18 * 2) / ROOK_EXTEND_FACTOR;

const int KNIGHT_GOOD_TARGET_SUM = 8;
const int KNIGHT_EXTEND = 1;
const int KNIGHT_EXTEND_MARGIN = KNIGHT_EXTEND * KNIGHT_GOOD_TARGET_SUM * 2;

const int INITIAL_BOTTOM_CANNON_PENALTY = 15;
const int TERMINAL_BOTTOM_CANNON_PENALTY = 5;

const int INITIAL_CENTER_CANNON_PENALTY = 30;
const int TERMINAL_CENTER_CANNON_PENALTY = 5;
const int INITIAL_SUPER_CENTER_CANNON_PENALTY = 40;
const int TERMINAL_SUPER_CENTER_CANNON_PENALTY = 10;

const int WEAK_STATUS_PENALTY = 20;
const int WEAK_STATUS_MARGIN = WEAK_STATUS_PENALTY * 3;

int RED_BOTTOM_CANNON_PENALTY = 0;
int RED_BOTTOM_CANNOM_MARGIN = 0;

int BLACK_BOTTOM_CANNON_PENALTY = 0;
int BLACK_BOTTOM_CANNOM_MARGIN = 0;

int RED_CENTER_CANNON_PENALTY = 0;
int RED_SUPER_CENTER_CANNON_PENALTY = 0;
int RED_CENTER_CANNON_MARGIN = 0;

int BLACK_CENTER_CANNON_PENALTY = 0;
int BLACK_SUPER_CENTER_CANNON_PENALTY = 0;
int BLACK_CENTER_CANNON_MARGIN = 0;

int RED_LAZY_MARGIN_1 = 0;
int RED_LAZY_MARGIN_2 = 0;
int RED_LAZY_MARGIN_3 = 0;
int RED_LAZY_MARGIN_4 = 0;

int BLACK_LAZY_MARGIN_1 = 0;
int BLACK_LAZY_MARGIN_2 = 0;
int BLACK_LAZY_MARGIN_3 = 0;
int BLACK_LAZY_MARGIN_4 = 0;