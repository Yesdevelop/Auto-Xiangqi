...
const int ROOK_EXTEND_FACTOR = 2;
const int ROOK_EXTEND_MARGIN = (ROOK_EXTEND * 18 * 2) / ROOK_EXTEND_FACTOR;

const int KNIGHT_GOOD_TARGET_SUM = 2;
const int KNIGHT_EXTEND = 5;
const int KNIGHT_EXTEND_MARGIN = KNIGHT_EXTEND * KNIGHT_GOOD_TARGET_SUM * 2;

const int INITIAL_BOTTOM_CANNON_PENALTY = 30;
const int INITIAL_BOTTOM_CANNON_PROTECTION_REWARD = 15;

const int INITIAL_CENTER_CANNON_PENALTY = 30;
const int INITIAL_CENTER_CANNON_PROTECTION_REWARD = 20;

int RED_BOTTOM_CANNON_PENALTY = 0;
int RED_BOTTOM_CANNON_PROTECTION_REWARD = 0;
int RED_BOTTOM_CANNOM_MARGIN = 0;

int BLACK_BOTTOM_CANNON_PENALTY = 0;
int BLACK_BOTTOM_CANNON_PROTECTION_REWARD = 0;
