...
const int BOTTOM_CANNON_PENALTY = 30;
const int BOTTOM_CANNON_PROTECTION_REWARD = 15;
const int BOTTOM_CANNOM_MARGIN = std::max<int>(BOTTOM_CANNON_PENALTY,BOTTOM_CANNON_PROTECTION_REWARD * 2);

const int CENTER_CANNON_PENALTY = 30;
const int SUPER_CENTER_CANNON_PENALTY = 20;
const int CENTER_CANNON_MARGIN = std::max<int>(CENTER_CANNON_PENALTY * 2,SUPER_CENTER_CANNON_PENALTY * 8);

const int CANNON_COMBINATION_MARGIN = BOTTOM_CANNOM_MARGIN + CENTER_CANNON_MARGIN;

const int LAZY_MARGIN_1 = CANNON_COMBINATION_MARGIN + ROOK_EXTEND_MARGIN + KNIGHT_EXTEND_MARGIN;
const int LAZY_MARGIN_2 = ROOK_EXTEND_MARGIN + KNIGHT_EXTEND_MARGIN;
const int LAZY_MARGIN_3 = KNIGHT_EXTEND_MARGIN;
