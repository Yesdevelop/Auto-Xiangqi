...
const int KNIGHT_EXTEND = 15;
const int KNIGHT_EXTEND_MARGIN = KNIGHT_EXTEND * KNIGHT_GOOD_TARGET_SUM * 2;

const int INITIAL_BOTTOM_CANNON_PENALTY = 10;

const int INITIAL_CENTER_CANNON_PENALTY = 10;
const int INITIAL_SUPER_CENTER_CANNON_PENALTY = 15;

const int WEAK_STATUS_PENALTY = 10;
