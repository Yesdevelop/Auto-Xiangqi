...
void testByUI()
{
    ...
    // fenCode = "3akab2/9/5c3/4c3p/4P1P2/p8/5r2P/5RR2/5K3/4r1B2 w - - 0 1";
    // fenCode = "3akab2/9/5c3/4C3p/4P1P2/p5R2/4cr2P/5R3/5K3/4r1B2 w - - 0 1";
    // fenCode = "2baka3/9/4b4/p3P1C2/n7p/1r7/P3P1N1P/6N2/9/1cRAKAB2 w - - 0 1";
